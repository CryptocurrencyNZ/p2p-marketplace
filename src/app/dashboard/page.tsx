        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="text-gray-400 text-sm">Age: {userData.age} • Joined {userData.joinedDate}</div>
              ...
              <div className="mt-4 grid grid-cols-3 gap-4">
                <div className="bg-gray-800/60 backdrop-blur-sm px-3 py-2 rounded-lg border border-gray-700">
                  ...
                  <p className="font-semibold text-green-400">{userData.reputation}</p>
                </div>
                <div className="bg-gray-800/60 backdrop-blur-sm px-3 py-2 rounded-lg border border-gray-700">
                  <p className="text-xs text-gray-400">Trades</p>
                  <p className="font-semibold text-white">{userData.totalTrades}</p>
                </div>
                <div className="bg-gray-800/60 backdrop-blur-sm px-3 py-2 rounded-lg border border-gray-700">
                  <p className="text-xs text-gray-400">Volume</p>
                  <p className="font-semibold text-white">{userData.volumeTraded}</p>
                </div>
              </div>
        ...
        {activeTab === 'listings' && (
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href="/create" className="text-green-400 text-sm flex items-center hover:text-green-300">
                    ...
                    <div className="flex justify-between items-start">
                      ...
                      <div className="flex items-center">
                        <div className="text-right mr-2">
                          <div className="text-gray-400 text-xs">{listing.listed}</div>
            ...
            {userData.currentListings.length === 0 && (
              <div className="text-center py-10">
                ...
                <h3 className="text-lg font-medium text-gray-300">No active listings</h3>
                <p className="text-gray-500 mt-1 max-w-sm mx-auto">
                  You don't have any items listed for sale. Create a new listing to get started.
                </p>
                <Link href="/create" className="mt-4 inline-flex bg-green-600 text-white font-medium text-sm px-4 py-2 rounded-lg hover:bg-green-500 transition-all">
                  Create Listing
                </Link>
              </div>
            )}
            ...
            <div className="p-5">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1">Brief description about yourself (max 200 characters)</p>
                </div>
              </div>
            </div>
