...
//   async function markFiatSent(): Promise<void> {
//     if (!signer) {
//       setStatus({
//         type: "error",
...
//       setStatus({
//         type: "loading",
//         message: `Marking fiat as sent for Trade ID ${tradeId}...`
//       });
      
//       const tx = await contract.markFiatSent(tradeId);
//       await tx.wait();
      
//       setStatus({
//         type: "success",
//         message: `Fiat marked as sent for Trade ID: ${tradeId}`
//       });
...
//           <label className="block text-sm font-medium text-gray-300" htmlFor="trade-id">
//             Trade ID
//           </label>
//           <input
//             id="trade-id"
...
//           aria-label="Mark fiat as sent for this trade"
//         >
//           {loading ? (
//             <>
