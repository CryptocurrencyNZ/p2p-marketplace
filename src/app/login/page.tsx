...
const WalletButton = dynamic(
  () => import('@/components/wallet-button'),
  { ssr: false }
);
...
>
              {isLoading.discord ? (
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 127.14 96.36" className="text-white">
        ...
        <div className="flex flex-col space-y-2 pt-0 pb-6 px-6 text-gray-400">
          <div className="text-xs text-center">
            ...
            <a href="/terms" className="text-green-400 ml-1 hover:text-green-300 transition-colors">Terms of Service</a> and
            <a href="/privacy" className="text-green-400 ml-1 hover:text-green-300 transition-colors">Privacy Policy</a>
          </div>
          <div className="text-center text-xs flex justify-center items-center gap-1 mt-1">
            <Monitor className="h-3 w-3 text-green-500" /> <Smartphone className="h-3 w-3 text-green-500" /> 
